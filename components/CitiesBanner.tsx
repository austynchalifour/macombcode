...
export default function CitiesBanner() {
  ...
  return (
    <section
      ...
      className="cities-banner relative overflow-hidden bg-navy py-5 md:py-6"
    >
      ...
      <p className="mb-3 px-5 text-center font-display text-[0.7rem] font-bold uppercase tracking-[0.28em] text-orange">
