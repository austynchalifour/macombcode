...
export default function Hero() {
  return (
    <section
      id="top"
      className="hero-atmosphere relative flex min-h-[100svh] flex-col overflow-hidden"
    >
      <div className="hero-grain absolute inset-0" aria-hidden />
      <Nav />

      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-1 flex-col justify-center px-5 pb-16 pt-6 md:px-10 md:pb-24 md:pt-4">
        <div className="grid max-w-5xl gap-8 md:grid-cols-[1.2fr_0.8fr] md:items-end md:gap-16">
